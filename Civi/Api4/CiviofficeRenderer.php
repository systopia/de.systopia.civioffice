...
use Civi\Civioffice\Api4\Action\Renderer\GetAction;
use Civi\Civioffice\Api4\Action\Renderer\GetFieldsAction;
use Civi\Civioffice\Api4\Traits\CiviofficePermissionTrait;

final class CiviofficeRenderer extends AbstractEntity {
