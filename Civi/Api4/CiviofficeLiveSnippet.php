...
use Civi\Civioffice\Api4\Action\LiveSnippet\GetAction;
use Civi\Civioffice\Api4\Action\LiveSnippet\GetFieldsAction;
use Civi\Civioffice\Api4\Traits\CiviofficePermissionTrait;

final class CiviofficeLiveSnippet extends AbstractEntity {
