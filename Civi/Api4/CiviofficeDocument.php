...
use Civi\Civioffice\Api4\Action\Document\GetAction;
use Civi\Civioffice\Api4\Action\Document\GetFieldsAction;
use Civi\Civioffice\Api4\Traits\CiviofficePermissionTrait;

final class CiviofficeDocument extends AbstractEntity {
