...
final class CRM_Civioffice_MimeType {
   ...
   *
   * Source: Symfony Mime component.
   *
   * @see https://github.com/symfony/symfony/blob/cadcc578af9ad9fe7a8dc87aa545083f23950e12/src/Symfony/Component/Mime/MimeTypes.php#L142
   *
   ...
   */
  public static function mapMimeTypeToFileExtension(string $mimeType): string {
    $extension = self::MAP[$mimeType][0] ?? NULL;
    if (NULL === $extension) {
      throw new InvalidArgumentException(sprintf('Missing file extension for MIME type "%s"', $mimeType));
    }
  ...
  /**
   * Checks if the file ending/extension matches with the given fully qualified
   * MIME type
   *
   * MIME type checks could be handled differently in the future:
   ...
   */
  public static function hasSpecificFileNameExtension(string $filename, string $mimeType): bool {
    return in_array(pathinfo($filename, PATHINFO_EXTENSION), self::MAP[$mimeType] ?? [], TRUE);
  }
