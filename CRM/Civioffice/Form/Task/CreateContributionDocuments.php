...
//                2000 => 2000
        ...
        // add buttons
        CRM_Core_Form::addDefaultButtons(E::ts("Generate %1 Files", [1 => count($this->_contributionIds)]));
    }
    ...
    public function postProcess()
    {
        ...
        $chunked_entities = array_chunk($this->_contributionIds, $values['batch_size'],false);
