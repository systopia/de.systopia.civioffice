  ...
  public function buildQuickForm() {
    ...
    $this->add(
        ...
        [
          ...
          20 => 20,
          50 => 50,
          // As soon as parallel conversion is solved and lock is removed higher values can be enabled again
          // https://github.com/systopia/de.systopia.civioffice/issues/6
          //                100 => 100,
          //                200 => 200,
          //                500 => 500,
          //                1000 => 1000,
  ...
  public function postProcess() {
    ...
    try {
      ...
      Civi::contactSettings()->set(
        'civioffice_create_' . static::class . '_activity_type', $values['activity_type_id'] ?? ''
      );
    }
